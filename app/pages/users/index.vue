        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
              Quản lý tài khoản, điểm thưởng và quyền hạn của người
              dùng.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <template #name-cell="{ row }">
              <div class="flex items-center gap-3 py-1">
                <UAvatar
                  :src="row.original.avatar_full_url"
            ...
            <template #total_points-cell="{ row }">
              <div class="flex flex-col gap-0.5">
                ...
                <div class="text-[10px] text-gray-500 pl-6">
                  Sử dụng: {{ row.original.used_points }}
                </div>
              </div>
            </template>
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="w-20 h-1 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                  <div
                    ...
                    :style="{ width: `${Math.min((row.original.exp / 1000) * 100, 100)}%` }"
                  />
                </div>
              </div>
            </template>
