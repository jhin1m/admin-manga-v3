...
<template>
    <UDashboardPanel>
        ...
        <template #body>
            ...
            <div v-else-if="user" class="max-w-7xl mx-auto w-full">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-8">
                            ...
                            <UForm :schema="schema" :state="state" @submit="onSubmit" class="space-y-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                    ...
                                    <UFormField label="Tổng điểm" name="total_points" required>
                                        <UInput v-model="state.total_points" type="number" size="md"
                                            icon="i-lucide-gem" />
                                    </UFormField>

                                    <UFormField label="Cấp độ hiện tại" name="level" required>
                                        <UInput v-model="state.level" type="number" size="md"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <UCard
                                ...
                                <p class="text-xs text-gray-500 mb-4">Việc cấm tài khoản sẽ khiến người dùng không thể
                                    truy cập hệ thống
                                    ngay lập tức.</p>
