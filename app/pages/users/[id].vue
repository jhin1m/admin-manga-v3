    ...
    <template #body>
      ...
      >
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-1 flex flex-col gap-8">
            ...
            >
              <div class="relative h-24 bg-gradient-to-r from-primary-500 to-indigo-600" />
              <div class="px-6 pb-6 pt-0 flex flex-col items-center">
                ...
                <div class="mt-8 w-full grid grid-cols-2 gap-4">
                  <div
                    class="p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/50 flex flex-col items-center"
                  >
              ...
              <template #footer>
                <div class="space-y-4">
                  <div class="flex flex-col gap-1">
                    <span class="text-[10px] uppercase font-bold text-gray-400 tracking-widest">ID
                      Hệ Thống</span>
                    <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <div class="flex flex-wrap gap-2">
                  <UBadge
                    v-for="(role, index) in user.roles || ['Member']"
              ...
              <UCard
                class="border-red-200 dark:border-red-900/30 bg-red-50/30 dark:bg-red-950/10 shadow-sm"
              >
                <template #header>
                ...
                <p class="text-xs text-gray-500 mb-4">
                  Việc cấm tài khoản sẽ khiến người dùng không thể
                  truy cập hệ thống
                  ngay lập tức.
                </p>
                <UButton
                  label="Cấm người dùng này"
                  color="error"
                  variant="outline"
                  icon="i-lucide-ban"
                  block
      ...
      >
        ...
        <p class="text-gray-500 mt-2 max-w-xs">
          Tài khoản này có thể đã bị xóa hoặc ID không chính xác.
        </p>
        <UButton
